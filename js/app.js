 ...
 */
    ...
    (() => {
        ...
        if (inputNumberPhone.length) modules_flsModules.inputmask = Inputmask("+7 (999) 999 99 99").mask(inputNumberPhone);
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new core(".feedback__slider", {
                ...
                navigation: {
                    prevEl: ".feedback__img-arrow-left",
                    nextEl: ".feedback__img-arrow-right"
                },
                on: {}
            });
        }
